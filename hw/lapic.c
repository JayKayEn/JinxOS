...
#define ID          (0x0020 >> 2)   // ID
#define VER         (0x0030 >> 2)   // Version
#define TPR         (0x0080 >> 2)   // Task Priority
#define EOI         (0x00B0 >> 2)   // EOI
#define SVR         (0x00F0 >> 2)   // Spurious Interrupt Vector
#define ENABLE      (0x00000100)   // Unit Enable
#define ESR         (0x0280 >> 2)   // Error Status
#define ICRLO       (0x0300 >> 2)   // Interrupt Command
...
#define ICRHI       (0x0310 >> 2)   // Interrupt Command [63:32]
#define TIMER       (0x0320 >> 2)   // Local Vector Table 0 (TIMER)
#define X1          (0x0000000B)   // divide counts by 1
#define PERIODIC    (0x00020000)   // Periodic
#define PCINT       (0x0340 >> 2)   // Performance Counter LVT
#define LINT0       (0x0350 >> 2)   // Local Vector Table 1 (LINT0)
#define LINT1       (0x0360 >> 2)   // Local Vector Table 2 (LINT1)
#define ERROR       (0x0370 >> 2)   // Local Vector Table 3 (ERROR)
#define MASKED      (0x00010000)   // Interrupt masked
#define TICR        (0x0380 >> 2)   // Timer Initial Count
#define TCCR        (0x0390 >> 2)   // Timer Current Count
#define TDCR        (0x03E0 >> 2)   // Timer Divide Configuration
